    ...
    <header class="absolute inset-x-0 top-0 z-20">
        <nav class="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
            ...
            <div class="hidden items-center gap-7 text-sm font-semibold text-white/85 sm:flex">
                <a href="#stays" class="hover:text-white">Stays</a>
        ...
        <section class="relative min-h-[88vh] overflow-hidden">
            ...
            <div class="relative z-10 mx-auto flex min-h-[88vh] max-w-7xl items-end px-5 pb-20 pt-28 sm:px-8 lg:pb-24">
                <div class="max-w-3xl text-white">
                    ...
                    <h1 class="text-5xl font-black leading-tight sm:text-6xl lg:text-7xl">Discover the art of refined travel</h1>
                    <p class="mt-6 max-w-2xl text-lg leading-8 text-white/82">
                        Find memorable hotels, local events, and weekend escapes curated for comfort, style, and easy planning.
                    </p>
                    <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                        <a href="#stays" class="inline-flex items-center justify-center rounded-md bg-amber-400 px-6 py-3 text-sm font-black text-slate-950 hover:bg-amber-300">
                            Explore stays
                        </a>
                        <a href="#subscribe" class="inline-flex items-center justify-center rounded-md border border-white/45 px-6 py-3 text-sm font-black text-white hover:bg-white/12">
                            Get travel guides
                        </a>
                    </div>
                </div>
